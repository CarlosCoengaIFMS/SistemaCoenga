...
--
-- Host: 127.0.0.1    Database: db_carlos_coenga
-- ------------------------------------------------------
...
CREATE TABLE `cmc_compras` (
  `cmc_id_compra` int NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `cmc_compras_produtos` (
  `cmc_id_compra_produto` int NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `cmc_produtos` (
  `cmc_id_produtos` int NOT NULL AUTO_INCREMENT,
  `cmc_nome` varchar(100) NOT NULL,
  `cmc_descricao` text,
...
CREATE TABLE `cmc_vendas` (
  `cmc_id_venda` int NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `cmc_vendas_produtos` (
  `cmc_id_venda_produto` int NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `cmc_vendedor` (
  `cmc_id_vendedor` int NOT NULL AUTO_INCREMENT,
  `cmc_nome` varchar(100) NOT NULL,
  `cmc_cpf` char(14) NOT NULL,
...
-- Dump completed on 2025-06-19 19:50:17
