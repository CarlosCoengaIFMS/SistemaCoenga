...
public class JDlgLogin extends javax.swing.JDialog {
    ...
    public JDlgLogin(java.awt.Frame parent, boolean modal) {
        ...
        setTitle("Login");
         // Foco direto no campo de usuário ao abrir
...
jPwdSenha.addFocusListener(new java.awt.event.FocusAdapter() {
    ...
    // Quando apertar ENTER no campo de usuário, vai para a senha
    jTxtUsuario.addActionListener(new java.awt.event.ActionListener() {
        public void actionPerformed(java.awt.event.ActionEvent evt) {
            jPwdSenha.requestFocusInWindow();
        }
    });

    // Quando apertar ENTER na senha, clica no botão Entrar
    jPwdSenha.addActionListener(new java.awt.event.ActionListener() {
        public void actionPerformed(java.awt.event.ActionEvent evt) {
            jBtnEntrar.doClick(); // simula o clique no botão Entrar
        }
    });
...
if (usuario.equalsIgnoreCase("Carlos") && senha.equals("123456")) {
    this.dispose(); // fecha o JDialog
    new JFrmPrincipal().setVisible(true); // abre a tela principal
} else {
